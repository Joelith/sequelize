...
class Model {
  ...
  _setInclude(key, value, options) {
    ...
    if (value[0] instanceof Model) {
      include.originalAttributes = true;
      if (association.isSingleAssociation) {
        this[accessor] = this.dataValues[accessor] = value[0];
      } else {
        this[accessor] = this.dataValues[accessor] = value;
      }
    }
        ...
        .tap(() => {
          ...
          return Promise.map(this._options.include.filter(include => !(include.association instanceof BelongsTo ||
            ...
            return Promise.map(instances, instance => {
              ...
              instance.set(include.association.foreignKey, this.get(include.association.sourceKey || this.constructor.primaryKeyAttribute, { raw: true }), { raw: false });
